...
function buildClosingPdfHref(input: {
  ...
  if (input.periodLabel?.trim()) params.set("periodLabel", input.periodLabel.trim());
...
export default async function RechnungenPage({
  ...
  const dailyClosingAllPdfHref = buildClosingPdfHref({
    periodType: "day",
    mode: "all",
    qRaw,
    filter: currentFilter,
  ...
  const monthlyClosingAllPdfHref = buildClosingPdfHref({
    periodType: "month",
    mode: "all",
    qRaw,
    filter: currentFilter,
  ...
  const yearlyClosingAllPdfHref = buildClosingPdfHref({
    periodType: "year",
    mode: "all",
    qRaw,
    filter: currentFilter,
            ...
            <div className="flex flex-col gap-5 lg:flex-row lg:items-start lg:justify-between">
              ...
              <div className="flex flex-col gap-3 rounded-2xl border border-white/10 bg-black/20 p-4">
                ...
                {monthlyClosingGroups.length > 0 ? (
                  <Link
                    href={monthlyClosingAllPdfHref}
                    target="_blank"
                    className="inline-flex h-11 w-full items-center justify-center rounded-xl border border-emerald-500/30 bg-emerald-600 px-4 text-sm font-semibold text-white hover:bg-emerald-500"
                  >
                    Monatsabschluss drucken / PDF
                  </Link>
                ) : null}
              </div>
            </div>
            ...
            <div className="flex flex-col gap-5 lg:flex-row lg:items-start lg:justify-between">
              ...
              <div className="flex flex-col gap-3 rounded-2xl border border-white/10 bg-black/20 p-4">
                ...
                {yearlyClosingGroups.length > 0 ? (
                  <Link
                    href={yearlyClosingAllPdfHref}
                    target="_blank"
                    className="inline-flex h-11 w-full items-center justify-center rounded-xl border border-emerald-500/30 bg-emerald-600 px-4 text-sm font-semibold text-white hover:bg-emerald-500"
                  >
                    Jahresabschluss drucken / PDF
                  </Link>
                ) : null}
              </div>
            </div>
