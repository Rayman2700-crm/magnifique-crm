        ...
        <div className="p-5 md:p-7">
          ...
          >
            <div className="flex flex-col gap-6">
              ...
              <div className="hidden md:grid md:grid-cols-[minmax(0,1fr)_auto] md:items-center md:gap-4">
                <form action="/rechnungen" method="get" className="min-w-0 w-full">
                  {currentFilter !== "all" ? <input type="hidden" name="filter" value={currentFilter} /> : null}
                  {practitionerFilter !== "all" ? <input type="hidden" name="practitioner" value={practitionerFilter} /> : null}
                  <div className="flex h-11 items-center rounded-[16px] border border-[var(--border)] bg-[var(--surface-2)] px-4">
                    <span className="mr-3 inline-flex h-4 w-4 shrink-0 items-center justify-center text-white/35">
                ...
                <Link
                  href="/calendar"
                  className="inline-flex h-11 min-w-[148px] shrink-0 items-center justify-center rounded-[16px] border border-emerald-500/30 bg-emerald-600/90 px-4 text-sm font-semibold text-white transition hover:bg-emerald-500"
                >
                  + Abrechnen
                </Link>
              </div>
