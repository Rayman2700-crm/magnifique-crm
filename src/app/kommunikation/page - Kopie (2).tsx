                ...
                <div className="w-full bg-transparent p-0">
                  <div className="relative w-full">
                    ...
                    <div className="relative flex w-full items-end">
                      ...
                      <details className="group absolute bottom-1.5 left-1.5 z-20">
                        <summary
                          className="inline-flex h-8 w-8 cursor-pointer list-none items-center justify-center rounded-full border border-[#d8c1a0]/14 bg-[#d8c1a0]/[0.045] text-lg font-semibold leading-none text-white transition hover:bg-[#d8c1a0]/[0.10] active:scale-[0.98] [&::-webkit-details-marker]:hidden"
                        ...
                        <div className="absolute bottom-11 left-0 flex w-[min(440px,calc(100vw-46px))] gap-2 rounded-[18px] border border-[#d8c1a0]/16 bg-[#211813]/96 p-2 shadow-[0_14px_34px_rgba(0,0,0,0.35)]">
                          <label className="flex flex-1 cursor-pointer items-center justify-center gap-2 rounded-[14px] border border-[#d8c1a0]/14 bg-[#d8c1a0]/[0.06] px-3 py-2 text-sm font-semibold text-[#f6f0e8] transition hover:bg-[#d8c1a0]/[0.10] active:scale-[0.98]">
                            <span aria-hidden="true">📎</span>
                            Datei
                            <input type="file" name="composer_file_placeholder" className="hidden" />
                          </label>
                          <button
                            type="button"
                      ...
                      <button
                        type="submit"
                        className="absolute bottom-1.5 right-1.5 z-10 inline-flex h-8 w-8 shrink-0 items-center justify-center rounded-full border border-[#d8c1a0]/14 bg-[#d8c1a0]/[0.045] text-white transition-colors hover:bg-[#d8c1a0]/[0.10] active:scale-[0.98]"
