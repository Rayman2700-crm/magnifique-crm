  ...
  return (
    <>
      <div className="clientique-login-logo">
        <div className="clientique-stage">
          <Image
            ...
            fill
            priority
            className="clientique-rings object-contain"
          />
          <Image
            src="/brand/text.png"
          ...
          <div className="clientique-line-wrap">
            <Image
              ...
              fill
              priority
              className="clientique-line object-contain"
            />
          </div>
        </div>
      </div>
      ...
      <style>{`
        ...
        .clientique-rings {
          opacity: 0.28;
          animation: ringsReveal 700ms ease-out forwards;
        }
        ...
        .clientique-text {
          ...
          animation: textReveal 700ms ease-out forwards;
          animation-delay: 250ms;
        }

        .clientique-line-wrap {
          position: absolute;
          inset: 0;
          overflow: hidden;
        ...
        .clientique-line {
          ...
          transform: scaleX(0);
          transform-origin: left center;
          animation: lineDraw 320ms ease-out forwards;
          animation-delay: 700ms;
        }

        @keyframes ringsReveal {
          from {
            opacity: 0.2;
          }
          to {
