          ...
          <CardContent className="px-1.5 py-2.5 sm:p-4.5 md:p-6.5 xl:p-7.5">
            ...
            <div className="pointer-events-none absolute inset-0">
              ...
              <div className="relative z-10 flex flex-col gap-6 xl:flex-row xl:items-center xl:justify-between">
                <div className="flex min-w-0 items-center gap-4.5 sm:gap-5.5">
                  <div
                    className="flex h-[74px] w-[74px] shrink-0 items-center justify-center overflow-hidden rounded-[22px] border-[4px] shadow-[0_0_0_2px_rgba(11,11,12,0.9)] sm:h-[82px] sm:w-[82px] md:h-[92px] md:w-[92px]"
                  ...
                  <div className="min-w-0">
                    <div className="text-[9px] font-semibold uppercase tracking-[0.16em] text-[var(--primary)]">
                      Magnifique Beauty Institut Dashboard
                    </div>
                    <div className="mt-2.5 break-words text-[27px] font-semibold leading-none tracking-[-0.03em] text-[var(--text)] sm:text-[31px] md:text-[36px] xl:text-[42px]">
                      {displayName}
                    </div>
                    <div className="mt-2.5 text-[13px] text-[var(--text-muted)] sm:text-[14px]">
                      {tenantDisplayName ?? "Studioansicht"}
                    </div>
                  </div>
                </div>

                <div className="hidden w-full rounded-[22px] border border-[rgba(255,255,255,0.035)] bg-[linear-gradient(180deg,rgba(255,250,244,0.040)_0%,rgba(255,248,240,0.012)_100%)] px-5.5 py-5 shadow-[0_14px_30px_rgba(0,0,0,0.12)] backdrop-blur-[20px] xl:block xl:w-auto xl:min-w-[244px]">
