          ...
          return (
            <form key={entry.tenant_id} action={action} className="shrink-0">
              ...
              <button type="submit" className="flex flex-col items-center gap-2" title={`${entry.displayLabel} anzeigen`}>
                <div className="relative overflow-hidden rounded-full" style={{ width: 56, height: 56, border: "4px solid rgba(255,255,255,0.30)", boxShadow: "0 12px 26px rgba(0,0,0,0.32)", background: "rgba(255,255,255,0.04)" }}>
                  {entry.user_id ? (
