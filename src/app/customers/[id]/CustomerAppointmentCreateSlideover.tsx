...
function getTriggerClassName(buttonSize: "default" | "sm" | "lg" | "icon") {
  if (buttonSize === "icon") {
    return "inline-flex h-10 w-10 items-center justify-center rounded-xl bg-white text-black hover:bg-white/90";
  }
  if (buttonSize === "lg") {
    return "inline-flex h-12 items-center justify-center rounded-xl bg-white px-5 text-base font-semibold text-black hover:bg-white/90";
  }
  if (buttonSize === "sm") {
    return "inline-flex h-9 items-center justify-center rounded-xl bg-white px-3 text-sm font-semibold text-black hover:bg-white/90";
  }
  return "inline-flex h-10 items-center justify-center rounded-xl bg-white px-4 text-sm font-semibold text-black hover:bg-white/90";
}
...
export default function CustomerAppointmentCreateSlideover({
  ...
  if (!mounted) {
    return (
      <button type="button" className={getTriggerClassName(buttonSize)} onClick={() => setOpen(true)}>
        {buttonLabel}
      </button>
    );
  }
