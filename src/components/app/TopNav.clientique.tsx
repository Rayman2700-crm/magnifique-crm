...
function getAvatarRingColor(userLabel?: string, currentUserId?: string) {
  ...
  if (normalized.includes("radu")) return "#D6C3A3";
  if (normalized.includes("raluca")) return "#B788D8";
  if (normalized.includes("alexandra")) return "#68B873";
  if (normalized.includes("barbara")) return "#E39C63";
          ...
          <button
            ...
            style={{
              ...
              boxShadow: avatarHovered
                ? `0 0 0 2px rgba(11,11,12,0.95), 0 0 0 4px ${avatarRingColor}, 0 0 0 8px rgba(255,255,255,0.08)`
                : `0 0 0 2px rgba(11,11,12,0.95), 0 0 0 4px ${avatarRingColor}`,
            }}
