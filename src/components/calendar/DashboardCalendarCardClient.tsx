...
function DailyAgendaPanel({
  ...
  const dayItems = useMemo(
    () =>
      items
        .filter((item) => isSameLocalISODate(item.start_at, selectedISO))
                ...
                <div className="min-w-0 flex-1 truncate text-[11px] text-white/84">
                  ...
                  {item.customerPhone ? (
                    <button
                      ...
                      className="inline-flex max-w-full items-center rounded-full border border-white/10 bg-white/[0.04] px-2 py-0.5 text-left text-white/92 transition hover:bg-white/[0.08]"
                    >
    ...
    <Card className="overflow-hidden border-[var(--border)] bg-[var(--surface)] shadow-[0_18px_50px_rgba(0,0,0,0.22)]">
      <CardContent className="p-5 md:p-6 xl:p-8">
        ...
        <div className="hidden md:block">
          <div className="relative pr-[360px] xl:pr-[520px]">
            <div className="absolute right-0 top-0 z-30 flex items-start justify-end gap-3">
              ...
              <div className="relative">
                ...
                {desktopSearchOpen ? (
                  <div className="absolute right-0 top-[calc(100%+14px)] z-40 w-[360px] max-w-[min(360px,calc(100vw-48px))] rounded-[24px] border border-white/10 bg-[linear-gradient(180deg,rgba(20,20,24,0.985)_0%,rgba(12,13,16,0.985)_100%)] p-3 shadow-[0_24px_70px_rgba(0,0,0,0.42)] backdrop-blur-xl">
                ...
                <div className="flex min-w-0 flex-1 flex-col gap-4">
                  ...
                  <div className="hidden md:grid md:grid-cols-1 md:gap-4 lg:grid-cols-3">
                    <div ref={miniMonthCardRef} className="lg:col-span-1">
                      <DesktopMiniMonthPicker valueISO={anchorISO} view={view} onSelect={handleSetDate} items={items} />
                    </div>
