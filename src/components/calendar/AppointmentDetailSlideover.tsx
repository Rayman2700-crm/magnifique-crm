                ...
                <div style={{ display: "grid", gap: 8 }}>
                  {canOpenCustomerProfile ? (
                    selected.customerProfileId ? (
                      <Link href={`/customers/${selected.customerProfileId}?tab=appointments#appointments`}>
                        <Button className="w-full">Zum Kundenprofil</Button>
                      </Link>
                    ) : (
                      <form action={openCustomerProfileFromAppointment.bind(null, selected.id)}>
                        <input type="hidden" name="returnTo" value={returnTo} />
                        <Button type="submit" className="w-full">Zum Kundenprofil</Button>
                      </form>
                    )
                  ) : (
                  ...
                  {canStartCheckout ? (
                    <button
                      ...
                      className="inline-flex h-10 w-full items-center justify-center rounded-xl border border-emerald-500/30 bg-emerald-600/80 px-4 text-sm font-semibold text-white hover:bg-emerald-600"
                    >
                      Abrechnen
                    </button>
                  ) : (
