                            ...
                            {isOpen ? (
                              <div
                                ...
                                style={{
                                  ...
                                  borderRadius: 16,
                                  background: "linear-gradient(180deg, rgba(14,14,18,0.995) 0%, rgba(8,8,11,0.995) 100%)",
                                  border: "1px solid rgba(255,255,255,0.16)",
                                  boxShadow: `0 26px 56px rgba(0,0,0,0.62), 0 0 0 1px rgba(0,0,0,0.35), 0 0 24px ${withAlpha(clusterTheme.primary, "1F")}`,
                              ...
                              >
                                <div style={{ fontSize: 11, fontWeight: 800, color: clusterTheme.subtle, padding: "0 2px 8px" }}>
                                  Termin wählen
                                </div>
