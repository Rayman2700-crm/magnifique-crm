...
function getClusterDisplayHeight(eventCount: number, sourceHeight: number) {
  const base = eventCount >= 5 ? 96 : eventCount === 4 ? 92 : 86;
  return Math.max(78, Math.min(base, Math.max(78, Math.min(sourceHeight, 98))));
}
                  ...
                  return (
                    ...
                    >
                      ...
                      {clusterInfo.clusters.map((cluster) => {
                        ...
                        const compactCluster = displayHeight <= 88;
                        ...
                        return (
                          ...
                          >
                            ...
                            <div style={{ position: "relative", zIndex: 2 }}>
                              ...
                              <div
                                style={{
                                  marginTop: compactCluster ? 7 : 8,
                                  fontSize: compactCluster ? 13 : 15,
                                  fontWeight: 900,
                                  color: clusterTheme.text,
                                  letterSpacing: "-0.01em",
                                  lineHeight: 1.08,
                                  display: "-webkit-box",
                                  WebkitLineClamp: compactCluster ? 2 : 2,
                                  WebkitBoxOrient: "vertical",
                                  overflow: "hidden",
                                }}
                              >
                              ...
                              >
                                <div style={{ display: "flex", alignItems: "center", gap: 6, minWidth: 0 }}>
                                  ...
                                  >
                                    {uniqueTenants.length === 1 ? uniqueTenants[0] : `${uniqueTenants.length} Behandler`}
                                  </span>
                                </div>
