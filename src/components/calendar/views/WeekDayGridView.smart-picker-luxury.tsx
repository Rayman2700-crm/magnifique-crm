                              ...
                              >
                                ...
                                <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
                                  <div style={{ display: "flex", alignItems: "center", gap: 4 }}>
                                    {accentColors.slice(0, 4).map((accent, index) => (
                                      <span
                                        key={`${cluster.id}-accent-${index}`}
                                        style={{
                                          width: 8,
                                          height: 8,
                                          borderRadius: 999,
                                          backgroundColor: accent,
                                          boxShadow: `0 0 8px ${withAlpha(accent, "66")}`,
                                        }}
                                      />
                                    ))}
                                  </div>
                              ...
                              >
                                <div style={{ display: "flex", alignItems: "center", gap: 6, minWidth: 0 }}>
                                  {cluster.events.slice(0, 4).map((ev, index) => {
                                    const dotAccent = luxuryTheme(tenantTheme(ev.tenantName)).accent;
                                    return (
                                      <span
                                        ...
                                        style={{
                                          ...
                                          border: `1px solid ${withAlpha(dotAccent, "66")}`,
                                          color: clusterTheme.text,
                                          fontSize: 10,
                                          fontWeight: 900,
                                          boxShadow: `0 0 10px ${withAlpha(dotAccent, "30")}`,
                                        }}
                                      >
                            ...
                            {isOpen ? (
                              <div
                                ...
                                style={{
                                  position: "absolute",
                                  left: "50%",
                                  top: Math.max(80, Math.min(totalHeight - 250, cluster.top + Math.max(72, Math.min(108, cluster.height)) + 12)),
                                  ...
                                  backgroundImage:
                                    "linear-gradient(180deg, rgba(26,26,32,0.98) 0%, rgba(10,10,12,0.995) 38%, rgba(6,6,8,1) 100%)",
                                  border: `1px solid ${withAlpha(clusterTheme.primary, "38")}`,
                                  boxShadow: `0 34px 80px rgba(0,0,0,0.82), 0 0 0 1px rgba(255,255,255,0.05), 0 0 34px ${withAlpha(clusterTheme.primary, "18")}`,
                                  padding: "10px",
                                  isolation: "isolate",
                                  overflow: "hidden",
                                  zIndex: 60,
                              ...
                              >
                                <div
                                  style={{
                                    ...
                                    pointerEvents: "none",
                                    background:
                                      "radial-gradient(circle at top right, rgba(255,255,255,0.09) 0%, transparent 28%), radial-gradient(circle at bottom left, rgba(255,255,255,0.04) 0%, transparent 24%)",
                                    opacity: 0.75,
                                  }}
                                />
                                <div
                                ...
                                >
                                  ...
                                  >
                                    {accentColors.slice(0, 5).map((accent, index) => (
                                      <span
                                        key={`${cluster.id}-picker-dot-${index}`}
                                        style={{
                                          width: 8,
                                          height: 8,
                                          borderRadius: 999,
                                          backgroundColor: accent,
                                          boxShadow: `0 0 10px ${withAlpha(accent, "88")}`,
                                        }}
                                      />
                                    ))}
                                  </div>
                                    ...
                                    return (
                                      <button
                                        ...
                                        style={{
                                          ...
                                          boxShadow: "inset 0 1px 0 rgba(255,255,255,0.05), 0 10px 22px rgba(0,0,0,0.22)",
                                          textAlign: "left",
                                          cursor: "grab",
                                          overflow: "hidden",
                                          touchAction: "none",
                                      ...
                                      >
                                        <span
                                          style={{
                                            width: 5,
                                            flexShrink: 0,
                                            background: `linear-gradient(180deg, ${rowAccent} 0%, ${withAlpha(rowAccent, "88")} 100%)`,
                                            boxShadow: `0 0 16px ${withAlpha(rowAccent, "66")}`,
                                          }}
                                        />
                                        <div
                                          style={{
                                            ...
                                            >
                                              <span
                                                style={{
                                                  ...
                                                  boxShadow: `0 0 10px ${withAlpha(rowAccent, "88")}`,
                                                  flexShrink: 0,
                                                }}
                                              />
                                              <span
