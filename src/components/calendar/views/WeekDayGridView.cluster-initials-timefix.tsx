                  ...
                  return (
                    ...
                    >
                      ...
                      {clusterInfo.clusters.map((cluster) => {
                        ...
                        const visibleClusterEvents = cluster.events.slice(0, 2);
                        ...
                        return (
                          ...
                          >
                            ...
                            <div style={{ position: "relative", zIndex: 2 }}>
                              ...
                              >
                                {visibleClusterEvents.map((ev, index) => {
                                  ...
                                  return (
                                    <span
                                      ...
                                      style={{
                                        ...
                                        fontSize: compactCluster ? 11 : 12,
                                        fontWeight: 900,
                                        lineHeight: 1,
                                        boxShadow: `0 0 12px ${evTheme.accentSoft}`,
                                        flexShrink: 0,
                                      }}
                                    >
                              ...
                              <span
                                style={{
                                  position: "absolute",
                                  right: 2,
                                  bottom: compactCluster ? 0 : 2,
                                  minWidth: compactCluster ? 18 : 19,
                                  height: compactCluster ? 18 : 19,
                                  borderRadius: 999,
                                  display: "inline-flex",
                                  alignItems: "center",
                                  justifyContent: "center",
                                  ...
                                  fontSize: compactCluster ? 9 : 10,
                                  fontWeight: 900,
                                  lineHeight: 1,
                                  boxShadow: `0 0 12px ${badge.sent ? "rgba(16,185,129,0.10)" : "rgba(245,158,11,0.12)"}`,
                                }}
                                title={badge.sent ? "Reminder gesendet" : "Reminder offen"}
                              >
                                {badge.tinyLabel}
                              </span>
                            </div>
