...
export default function WeekDayGridView(props: {
  ...
  const visibleDayIsos = useMemo(
    () => (view === "week" ? weekDays.map((d) => d.iso) : [anchorISO]),
    [anchorISO, view, weekDays]
  );
        ...
        <div className="mt-4 overflow-hidden rounded-2xl border border-white/10 bg-black/30">
          ...
          >
            ...
            >
              ...
              >
                <div />
                {visibleDayIsos.map((iso) => {
                  const d = weekDays.find((x) => x.iso === iso)!;
                  const head = fmtDayHeader(d.date);
                  const count = (view === "week" ? positionedWeekByDay.get(iso) : positionedDay)?.length ?? 0;
                  ...
                  return (
                    ...
                    >
                      <div className="flex items-center justify-between gap-2">
                        ...
                        {count > 0 ? (
                          <div className="rounded-full border border-white/10 bg-white/5 px-2 py-1 text-[11px] font-semibold text-white/70">
                          ...
                          return (
                            <button
                              ...
                              style={{
                                position: "absolute",
                                top: ev._top,
                                height: Math.max(ev._height, isTiny ? 28 : 38),
                                ...
                                zIndex: tooltipOpen ? 30 : isDragging ? 20 : 12,
                                ...
                                <>
                                  <span
                                    style={{
                                      ...
                                      alignItems: "center",
                                      justifyContent: "center",
                                      background: badge.solidBg,
                                      color: badge.solidText,
                                  ...
                                  <div style={{ paddingRight: isCompact ? 20 : 24 }}>
                                    <div
                                      style={{
                                    ...
                                    >
                                      {isCompact ? fmtShortTime(ev._timeLine) : ev._timeLine}
                                    </div>
