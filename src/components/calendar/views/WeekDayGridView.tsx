                            ...
                            {isOpen ? (
                              <div
                                ...
                                style={{
                                  position: "absolute",
                                  left: "50%",
                                  top: Math.max(80, Math.min(totalHeight - 190, cluster.top + Math.max(72, Math.min(108, cluster.height)) + 10)),
                                  transform: "translateX(-50%)",
                                  width: 272,
                                  maxWidth: "calc(100% - 12px)",
                                  borderRadius: 18,
                                  backgroundColor: "rgba(8,8,10,1)",
                                  backgroundImage: "linear-gradient(180deg, rgba(22,22,27,0.98) 0%, rgba(8,8,10,1) 100%)",
                                  border: "1px solid rgba(255,255,255,0.22)",
                                  boxShadow: `0 30px 70px rgba(0,0,0,0.78), 0 0 0 1px rgba(0,0,0,0.45), 0 0 30px ${withAlpha(clusterTheme.primary, "24")}`,
                                  padding: "10px",
                                  isolation: "isolate",
                                  zIndex: 60,
                                }}
                                    ...
                                    return (
                                      <button
                                        ...
                                        style={{
                                          ...
                                          backgroundImage: "linear-gradient(180deg, rgba(255,255,255,0.05) 0%, rgba(255,255,255,0.025) 100%)",
                                      ...
                                      >
                                        <div style={{ minWidth: 0, display: "flex", alignItems: "center", gap: 8 }}>
                                          ...
                                          <div style={{ minWidth: 0 }}>
                                            <div style={{ fontSize: 12, fontWeight: 800, color: clusterTheme.text, whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" }}>
                                              {ev._customer}
                                            </div>
                                            <div style={{ marginTop: 2, fontSize: 10, fontWeight: 700, color: clusterTheme.muted, whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" }}>
                                              {ev._timeLine} · {ev.tenantName}
                                            </div>
                                          </div>
                                        </div>
                                        <span
                            ...
                            >
                              ...
                              <div
                                ...
                                onPointerDown={(e) => {
                                  e.preventDefault();
                                  e.stopPropagation();
                                  onPointerDownEvent(e as unknown as React.PointerEvent<HTMLButtonElement>, ev.id, iso, ev);
                                }}
                                onClick={(e) => {
                                  e.preventDefault();
                                  e.stopPropagation();
