            ...
            <section className={`studio-assistant-panel ${shown ? "studio-assistant-panel--shown" : ""}`}>
              <header className="studio-assistant-panel__header">
                ...
                <button
                  type="button"
                  onClick={close}
                  className="inline-flex h-11 w-11 items-center justify-center rounded-2xl border border-red-400/25 bg-red-500/10 text-red-100 shadow-[inset_0_1px_0_rgba(255,255,255,0.05)] hover:border-red-300/40 hover:bg-red-500/18 hover:text-white"
              ...
              >
                <div className="relative">
                  ...
                  <button
                    type="submit"
                    className="absolute bottom-3 right-3 inline-flex h-9 w-9 items-center justify-center rounded-2xl border border-white/12 bg-white/[0.06] text-base font-bold text-white/90 shadow-[inset_0_1px_0_rgba(255,255,255,0.05)] hover:border-[#d8c1a0]/35 hover:bg-[#d8c1a0]/16 hover:text-white hover:shadow-[0_10px_28px_rgba(0,0,0,0.22),inset_0_1px_0_rgba(255,255,255,0.08)] disabled:cursor-not-allowed disabled:opacity-40 disabled:hover:border-white/12 disabled:hover:bg-white/[0.06]"
